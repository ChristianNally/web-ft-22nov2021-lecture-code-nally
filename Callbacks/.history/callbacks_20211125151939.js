...
function performYourActionThreeTimes(callback){
  for (let i = 0; i < 3; i++){
    callback('i=' + i); // action is a parameter that takes on a value, as passed in when performYourActionThreeTimes is called.
  }
}
