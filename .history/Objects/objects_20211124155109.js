...
console.log("Object.keys(voter)",Object.keys(voter));
...
voters.push({name: 'Sally',age: 15});

for (let ii = 0; ii < voters.length; ii++){
  console.log(`object at voters[${ii}]`,voters[ii]);
}
...
anotherVoter.speak("Chicken McNuggets!");
anotherVoter.vote("Cheese McBurger");
