const collectionOfPromises = require('./promise-generator');

const returnPromise = collectionOfPromises.returnPromise;
const returnRejectedPromise = collectionOfPromises.returnRejectedPromise;
